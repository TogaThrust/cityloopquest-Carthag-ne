/**
 * Réécrit les descriptions POI Carthagène en textes visiteurs, sans formulation interne.
 * Usage: node scripts/rewrite-carthagene-poi-descriptions.mjs
 */
import fs from "fs";
...
function rewrite(lang, poi) {
  ...
  const city = poi.city || "Carthagène";
